...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGTPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
/**
 * 
 */
UCLASS()
class GASTOOLS_API UPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
private:
	...
	UGTPAbilitySystemComponent* GetTargetASC();
