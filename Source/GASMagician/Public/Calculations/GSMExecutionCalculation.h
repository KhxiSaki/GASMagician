...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category="Calculation", meta=(DisplayName="Execute (GAS Magician)"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Captured Attribute Magnitude With Base", ScriptName="GetCapturedAttributeMagnitudeWithBase"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Captured Attribute Magnitude Base Value", ScriptName="GetCapturedAttributeMagnitudeBaseValue"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Captured Attribute Bonus Magnitude", ScriptName="GetCapturedAttributeBonusMagnitude"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Transient Aggregator Magnitude", ScriptName="GetTransientAggregatorMagnitude"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Transient Aggregator Magnitude With Base", ScriptName="GetTransientAggregatorMagnitudeWithBase"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Transient Aggregator Base Value", ScriptName="GetTransientAggregatorBaseValue"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure = false, Category = "Ability|GameplayEffect", meta=(DisplayName="Get Transient Aggregator Bonus Magnitude", ScriptName="GetTransientAggregatorBonusMagnitude"))
	...
	UFUNCTION(BlueprintPure, Category = "GSMExecutionCalculation")
