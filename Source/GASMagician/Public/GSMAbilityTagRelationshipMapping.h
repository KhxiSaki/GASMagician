...
private:
	...
	UPROPERTY(EditAnywhere, Category = "GASMagician", meta=(TitleProperty="AbilityTag"))
	TArray<FGSMAbilityTagRelationship> AbilityTagRelationships;
