...
/**
 * Main Slate Widget for creating new MVVM Model class
 *
 * Most of its code comes from SNewClassDialog
 */
class GASMAGICIANGAMEPROJECTGENERATION_API SGSMNewMVVMModelClassDialog : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SGSMNewMVVMModelClassDialog)
	{}
...
private:
	...
	FNewClassInfo ParentClassInfo = FNewClassInfo(UMVVMViewModelBase::StaticClass());
